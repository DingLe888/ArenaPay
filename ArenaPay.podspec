...
Pod::Spec.new do |s|
  s.name             = 'ArenaPay'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ArenaPay.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/18911755085@163.com/ArenaPay'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '18911755085@163.com' => '18911755085@163.com' }
  s.source           = { :git => 'https://github.com/18911755085@163.com/ArenaPay.git', :tag => s.version.to_s }
